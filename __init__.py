...
class transmitter_testbench(thesdk):
    ...
    def main(self):
        ...
        def ACPR_bit_sweep():
            ...
            #types=["cartesian", "polar", "outphasing", "multileveloutphasing", 
            #"multileveloutphasing", "multileveloutphasing", "multileveloutphasing"] #Eri A_MAX arvoilla
            for d.transmittertype in types:  #Loop for amplitude-bits
                ...
                for d.phase_bits in range(3, 13, 1):
                    d.run()
            ...
            plot.plot(bits, ACLRdict["multileveloutphasing1"], linestyle=":", label="Monitasoinen poisvaiheistus $A_{MAX}$=2")
            """plot.plot(bits, ACLRdict["multileveloutphasing2"], linestyle="-.", label="Monitasoinen poisvaiheistus $A_{MAX}$=2")
            plot.plot(bits, ACLRdict["multileveloutphasing3"], linestyle=":", label="Monitasoinen poisvaiheistus $A_{MAX}$=3")
            plot.plot(bits, ACLRdict["multileveloutphasing4"], linestyle="--", label="Monitasoinen poisvaiheistus $A_{MAX}$=4")"""
            plot.xlabel("Vaihebitit")
            plot.ylabel("$ACPR_1$ (dB)")
            ...
            plot.plot(bits, ACLRdict2["multileveloutphasing1"], linestyle=":", label="Monitasoinen poisvaiheistus $A_{MAX}$=2")
            """plot.plot(bits, ACLRdict2["multileveloutphasing2"], linestyle="-.", label="Monitasoinen poisvaiheistus $A_{MAX}$=2")
            plot.plot(bits, ACLRdict2["multileveloutphasing3"], linestyle=":", label="Monitasoinen poisvaiheistus $A_{MAX}$=3")
            plot.plot(bits, ACLRdict2["multileveloutphasing4"], linestyle="--", label="Monitasoinen poisvaiheistus $A_{MAX}$=4")"""
            plot.xlabel("Vaihebitit")
            plot.ylabel("$ACPR_2$ (dB)")
            plot.xticks(bits, bits)
            plot.legend()
            g.show()
        ...
        def EVM_bit_sweep():
            ...
            r.Factor=128"""
            EVMdict={"cartesian": 0, "polar": 0, "outphasing": 0, "multileveloutphasing1": 0, "multileveloutphasing2": 0}
            keyslist=list(EVMdict.keys())
            types=["cartesian", "polar", "outphasing", "multileveloutphasing"]
            #types=["cartesian", "polar", "outphasing", "multileveloutphasing", "multileveloutphasing"]
            for d.transmittertype in types:  #Loop for amplitude-bits
                EVMarray=[]
                #if d.transmittertype=="multileveloutphasing":
                    #d.A_MAX+=2
            ...
            plot.plot(bits, EVMdict["multileveloutphasing1"], linestyle=":", label="Monitasoinen poisvaiheistus $A_{MAX}$=2")
            #plot.plot(bits, EVMdict["multileveloutphasing2"], linestyle="-.", label="Monitasoinen poisvaiheistus $A_{MAX}$=4")
            plot.xlabel("Vaihe bitit")
            plot.ylabel("EVM (%)")
            plot.xticks(bits, bits)
            plot.legend()
            plot.show()
        ...
        d.phase_bits=12
        d.Inter_factor=128
        d.Interpolator_type="sample_and_hold"
        #d.Interpolator_type="zeropadding"
